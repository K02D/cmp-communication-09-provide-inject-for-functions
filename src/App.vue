...
export default {
  ...
  // Component hierarchy: KnowledgeBase -> KnowledgeGrid -> KnowledgeElement
  // Pass data to KnowledgeGrid and KnowledgeElement without going through KnowledgeBase using provide()
  provide() {
    return {
      topics: this.topics,
  ...
  // Add a new topic 3 seconds after the component is mounted
  mounted() {
    setTimeout(() => {
      this.topics.push({
        id: 'events',
